...
export default function ChristianPage() {
  ...
  // 🌟 حفظ النقاط في قاعدة بيانات Supabase (profiles + heroes)
          ...
          >
            ...
            >
              ...
              <p style={{ color: "#a0a0b5", fontSize: "18px", marginBottom: "30px" }}>
                كسبت 10 نقاط جديدة وسُجلت في رصيدك السحابي! <br />
                مجموع نقاطك:{" "}
                <span style={{ color: "#00b894", fontWeight: "bold" }}>{totalPoints}</span>
              </p>
              <button
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px", paddingBottom: "50px" }}>
        ...
        {activeSection === "bible" &&
          (isLoadingBible ? (
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "20px" }}>
              {bibleBooks.map((book) => (
                ...
                >
                  ...
                  <h3 style={{ fontSize: "18px", color: "white", margin: "0 0 8px 0" }}>
                    {arabicBookNames[book.name] || book.name}
                  </h3>
                  <span
                    style={{
            ...
            <div>
              <h2 style={{ color: "#fdcb6e", textAlign: "center", marginBottom: "25px", fontSize: "26px" }}>
                {arabicBookNames[selectedBibleBook.name] || selectedBibleBook.name}
              </h2>
            ...
            {christianData[activeSection].map((item: any) => (
              <div
                ...
                onClick={() => {
                  ...
                  if (activeSection === "rosary") setHailMaryCount(0);
                }}
              >
                <div style={{ fontSize: "40px", marginBottom: "10px" }}>{item.icon}</div>
                <h3 style={{ fontSize: "19px", color: "white", marginBottom: "5px" }}>
                  {item.titleAr || item.title}
                </h3>
                <span style={{ color: "#fdcb6e", fontSize: "13px" }}>
        ...
        {selectedItem && (
          <div className="video-overlay" onClick={() => setSelectedItem(null)} style={{ zIndex: 900 }}>
            ...
            >
              ...
              <h2 style={{ color: "#00b894", marginBottom: "10px", fontSize: "24px" }}>
                {selectedItem.titleAr || selectedItem.title}
              </h2>
              <p style={{ color: "#fdcb6e", fontSize: "14px", marginBottom: "20px" }}>
                {selectedItem.subtitleAr || selectedItem.subtitle}
              </p>
              ...
              >
                {selectedItem.type === "bible_chapter" ? (
                  <p style={{ color: "white", fontSize: "20px", lineHeight: "2", textAlign: "justify" }}>
                    {selectedItem.content.map((verseObj: any) => (
                      <span key={verseObj.pk}>
                        {verseObj.text}{" "}
                        <span style={{ color: "#fdcb6e", fontSize: "16px", margin: "0 4px" }}>
                          ﴿{verseObj.verse}﴾
                        </span>
                      </span>
                    ))}
                  ...
                  <p style={{ color: "#d1d1e0", fontSize: "20px", lineHeight: "1.8" }}>
                    {selectedItem.contentAr || selectedItem.content}
                  </p>
                )}
                ...
                {activeSection === "rosary" && (
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        padding: "12px 25px",
                        backgroundColor: hailMaryCount === 10 ? "#00b894" : "#e84393",
                        color: "white",
                        border: "none",
                        borderRadius: "15px",
                        fontSize: "16px",
                    ...
                    >
                      {hailMaryCount === 10
                        ? "✅ أتممت 10 مرات"
                        : `السلام عليك يا مريم (${hailMaryCount}/10)`}
                    </button>
                    {hailMaryCount === 10 && (
                      <h4 style={{ color: "#fdcb6e", fontSize: "17px" }}>
                ...
                {activeSection === "rosary" ? (
                  hailMaryCount === 10 && (
                    <button
                      ...
                      style={{
                        padding: "12px 30px",
                        backgroundColor: isUpdatingPoints ? "#636e72" : "#0984e3",
                        color: "white",
                        border: "none",
                        borderRadius: "15px",
                        fontSize: "16px",
                        fontWeight: "bold",
                        cursor: isUpdatingPoints ? "wait" : "pointer",
                      }}
                    >
                      {isUpdatingPoints ? "جاري تسجيل النقاط..." : "أتممت السر واستلام الجائزة 🎁"}
                    </button>
                  )
                ) : (
                  <button
                  ...
                  >
                    {isUpdatingPoints ? "جاري تسجيل النقاط..." : "أتممت القراءة واستلام الجائزة 🎁"}
                  </button>
                )}
              </div>
            </div>
